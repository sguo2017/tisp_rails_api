class Api::Goods::ServOffersController < ApplicationController
  ...
  private
    ...
    def serv_offer_params
      params.require(:serv_offer).permit(:serv_title, :serv_detail, :serv_images, :serv_catagory, :catalog, :goods_catalog_id, :user_id, :district, :city, :province, :country, :latitude, :longitude, :via, :orders_count)
    end
end
