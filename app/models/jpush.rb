class Jpush
  ...
  def Jpush.singleMsgPush(regId, msgContent)
  ...
  def Jpush.singleMsgPushV2(regId, msgContent)
    ...
    system "curl -X POST -v https://api.jpush.cn/v3/push -H 'Content-Type: application/json' -u '550e59c50b9bb72ad34ab473:e0e54eb860345971931c8af9' -d  '{\"platform\":\"all\",\"audience\":{\"registration_id\" : [\"#{regId}\"]},\"notification\":{\"alert\":\"#{msgContent}\"}}' ";
  end
