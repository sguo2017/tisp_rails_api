...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { obj_id: @favorite.obj_id, obj_type: @favorite.obj_type, user_id: @favorite.user_id } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { obj_id: @favorite.obj_id, obj_type: @favorite.obj_type, user_id: @favorite.user_id } }
